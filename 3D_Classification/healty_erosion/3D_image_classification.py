...
abnormal_scan_paths = [
    os.path.join(os.getcwd(), "erosion", x)
    for x in os.listdir("erosion")
]
...
x_train = np.concatenate((abnormal_scans[:108], normal_scans[:108]), axis=0)
y_train = np.concatenate((abnormal_labels[:108], normal_labels[:108]), axis=0)
x_val = np.concatenate((abnormal_scans[108:], normal_scans[108:]), axis=0)
y_val = np.concatenate((abnormal_labels[108:], normal_labels[108:]), axis=0)
print(
