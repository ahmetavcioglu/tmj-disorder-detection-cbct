...
abnormal_scan_paths = [
    os.path.join(os.getcwd(), "osteophyte", x)
    for x in os.listdir("osteophyte")
]
...
x_train = np.concatenate((abnormal_scans[:45], normal_scans[:45]), axis=0)
y_train = np.concatenate((abnormal_labels[:45], normal_labels[:45]), axis=0)
x_val = np.concatenate((abnormal_scans[45:], normal_scans[45:]), axis=0)
y_val = np.concatenate((abnormal_labels[45:], normal_labels[45:]), axis=0)
print(
