...
abnormal_scan_paths = [
    os.path.join(os.getcwd(), "subchondral", x)
    for x in os.listdir("subchondral")
]
...
x_train = np.concatenate((abnormal_scans[:12], normal_scans[:12]), axis=0)
y_train = np.concatenate((abnormal_labels[:12], normal_labels[:12]), axis=0)
x_val = np.concatenate((abnormal_scans[12:], normal_scans[12:]), axis=0)
y_val = np.concatenate((abnormal_labels[12:], normal_labels[12:]), axis=0)
print(
