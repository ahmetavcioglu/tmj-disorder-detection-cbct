...
normal_scan_paths = [
    os.path.join(os.getcwd(), "healty", x)
    for x in os.listdir("healty")
]
# Folder "CT-23" consist of CT scans having several ground-glass opacifications,
# involvement of lung parenchyma.
abnormal_scan_paths = [
    os.path.join(os.getcwd(), "diseased", x)
    for x in os.listdir("diseased")
]

print("CT scans with healty: " + str(len(normal_scan_paths)))
print("CT scans with diseased: " + str(len(abnormal_scan_paths)))
...
x_train = np.concatenate((abnormal_scans[:130], normal_scans[:130]), axis=0)
y_train = np.concatenate((abnormal_labels[:130], normal_labels[:130]), axis=0)
x_val = np.concatenate((abnormal_scans[130:], normal_scans[130:]), axis=0)
y_val = np.concatenate((abnormal_labels[130:], normal_labels[130:]), axis=0)
print(
