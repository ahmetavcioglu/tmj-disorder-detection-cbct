...
abnormal_scan_paths = [
    os.path.join(os.getcwd(), "sclerosis", x)
    for x in os.listdir("sclerosis")
]
...
x_train = np.concatenate((abnormal_scans[:34], normal_scans[:34]), axis=0)
y_train = np.concatenate((abnormal_labels[:34], normal_labels[:34]), axis=0)
x_val = np.concatenate((abnormal_scans[34:], normal_scans[34:]), axis=0)
y_val = np.concatenate((abnormal_labels[34:], normal_labels[34:]), axis=0)
print(
